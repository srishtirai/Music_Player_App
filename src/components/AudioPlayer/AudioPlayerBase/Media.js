...
class Media extends React.Component {
  ...
  constructor(props) {
    ...
    for (let eventName in props.customMediaEventsMap) {
      ...
      this.handledCustomMediaForwards[eventName] = (ev) =>
        forwardEvent(ev, this.props);
    }
  }
  ...
  render() {
    ...
    return (
      <Component {...rest} {...this.handledMediaEvents} ref={this.mediaRef}>
        {source}
        {track}
      </Component>
    );
...
export { getKeyFromSource, handledMediaEventsMap, Media };
